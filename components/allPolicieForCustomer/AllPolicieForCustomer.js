...
const AllPolicieForCustomer = () => {
    ...
    const updateSend = async () => {
        try {
            await UpdatePolicy(insuranceType, planName, primimumType, totalPremimumAmount, profitRatio, sumAssured, requestStatus, customerId, agentId, planId, id);
            console.log(res);
...
export default AllPolicieForCustomer;
