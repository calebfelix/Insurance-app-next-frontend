...
const AllInsuranceTypeCustomer = () => {  
  ...
  const handelAllInsurance = async (e) => {
    try {
      ...
      let response1 = await getAllInsuranceType({})
  ...
  const handleBuyPlan=(d)=>{
    router.push(`/buyplan/${d.id}`)
  }
...
export default AllInsuranceTypeCustomer;
