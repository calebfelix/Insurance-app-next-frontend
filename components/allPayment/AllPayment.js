...
import { getAllPayment } from "@/services/payment/getAllPayment";
...
const AllPayment = () => {
  ...
  const handelAllAgent = async (e) => {
    try {
      ...
      let response = await getAllPayment(filters);
      let response1 = await getAllPayment({});
      console.log(response);
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="w-[100%] p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-4 md:p-4 dark:bg-gray-700 dark:border-gray-700">
              <form className="space-y-6">
                ...
                <div>
                  <label className="my-form-label">Agent Email</label>
                  <input
                    className="my-form-input"
                    value={email}
                    onChange={(e) => {
                ...
                <div>
                  ...
                  <input
                    ...
                    value={qualification}
                    onChange={(e) => {
                      setQualification((prev) => e.target.value);
                    }}
                  ></input>
                </div>
                <div>
                  ...
                  <input
                    ...
                    value={agentAddress}
                    onChange={(e) => {
                      setAgentAddress((prev) => e.target.value);
                    }}
                  ></input>
                </div>
                <div>
